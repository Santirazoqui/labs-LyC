...
Body :: { AbsCpp.Body }
Body : '{' ListStm '}' { AbsCpp.Body1 $2 } | ';' { AbsCpp.Body2 }

Def :: { AbsCpp.Def }
Def
  : Type Id '(' ListArg ')' Body { AbsCpp.DFun $1 $2 $4 $6 }
  | 'inline' Type Id '(' ListArg ')' Body { AbsCpp.DInlineFun $2 $3 $5 $7 }
...
Exp15 :: { AbsCpp.Exp }
Exp15 : Id '(' ListExp ')' { AbsCpp.EApp $1 $3 } | Exp16 { $1 }

Exp14 :: { AbsCpp.Exp }
Exp14
  : Exp14 '.' Exp15 { AbsCpp.EMemberAccess $1 $3 }
  | Exp14 '->' Exp15 { AbsCpp.EPointerAccess $1 $3 }
...
TempInst :: { AbsCpp.TempInst }
TempInst
  : Id '<' ListType '>' { AbsCpp.TemplateInstantiation $1 $3 }

Type3 :: { AbsCpp.Type }
Type3
  : 'bool' { AbsCpp.Type3_bool }
  | 'int' { AbsCpp.Type3_int }
  | 'double' { AbsCpp.Type3_double }
  | 'void' { AbsCpp.Type3_void }
  | 'string' { AbsCpp.Type3_string }

Type2 :: { AbsCpp.Type }
Type2
  : Type3 { AbsCpp.Type2Type3 $1 }
  | TempInst { AbsCpp.Type2TempInst $1 }

Type1 :: { AbsCpp.Type }
Type1
  : Type2 { AbsCpp.Type1Type2 $1 } | Type2 '&' { AbsCpp.Type11 $1 }

Type :: { AbsCpp.Type }
Type
  : Type1 { AbsCpp.TypeType1 $1 } | 'const' Type1 { AbsCpp.Type1 $2 }
